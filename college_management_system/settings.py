...
ALLOWED_HOSTS = ['127.0.0.1', '.vercel.app', '.https://django-project-c5jh1wiqw-shivsagardahiyas-projects.vercel.app']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = env("EMAIL_ADDRESS")  # Load email from .env
EMAIL_HOST_PASSWORD = env("EMAIL_PASSWORD")  # Load password from .env
